...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex h-screen bg-[var(--bg-main)] overflow-hidden font-sans antialiased text-zinc-900">
      ...
      {/* ── Main content area ────────────────────────── */}
      <div className="relative flex min-h-0 flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-200 scrollbar-track-transparent">
          <div className="relative p-4 md:p-8 lg:p-10 max-w-[1600px] mx-auto animate-in fade-in duration-700 dashboard-page">
            <Outlet />
          </div>
